void setupPlayer2(Body circle_body, float x1, float y1, float x2, float y2, float x3, float y3){
}

void drawPlayer2(Body circle_body, float x1, float y1, float x2, float y2, float x3, float y3){
  // ボールに中心方向の力を加える
